...
-----------------------------------------------------
src/sealr/__init__.py      12      0   100%
src/sealr/core.py         145      7    95%   78-82, 156
src/sealr/cli.py           89      4    96%   234-237
-----------------------------------------------------
TOTAL                     246     11    96%
...
nox -s typecheck -- src/sealr/core

# Check specific file
nox -s typecheck -- src/sealr/cli.py
```
