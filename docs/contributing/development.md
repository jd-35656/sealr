...
```bash
git remote add upstream https://github.com/jd-35656/sealr.git
git fetch upstream
```
...
```bash
sealr --version         # Check command availability
...
| Task             | Command                                    |
| ---------------- | ------------------------------------------ |
| Run application  | `sealr --help` or `python -m sealr --help` |
...
3. Check [open issues](https://github.com/jd-35656/sealr/issues) for contribution ideas
4. Join [GitHub Discussions](https://github.com/jd-35656/sealr/discussions) for questions
